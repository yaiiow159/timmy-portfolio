      ...
      >
        ...
        >
          ...
          <div 
            ...
            class="absolute top-2 left-2 bg-accent/90 text-white px-2 py-1 rounded-md text-sm font-medium"
          >
            {{ t('admin.featured') }}
          </div>
          <div 
            ...
            <form @submit.prevent="saveProject" class="space-y-6">
              ...
              <div class="flex items-center">
                <input 
                  ...
                  type="checkbox" 
                  id="project-featured"
                  class="w-4 h-4 text-accent bg-primary dark:bg-primary-dark border-gray-300 dark:border-gray-700 rounded focus:ring-accent dark:focus:ring-accent-light"
                />
                <label class="ml-2 text-sm font-medium text-text-secondary dark:text-text-secondary-dark" for="project-featured">
                  {{ t('admin.featured') }}
                </label>
              </div>
            </form>
