...
import HomeFeaturedBlog from '@/components/home/HomeFeaturedBlog.vue'

const { t } = useI18n()
const router = useRouter()
const portfolioStore = usePortfolioStore()
const { loadList } = useBlogPostList()
...
const { animateHeroElements } = useHeroAnimation(animationComplete)
...
const {
  ...
  stopCarousel,
  cleanupAllCarousels
} = useProjectCarousel(() => portfolioStore.featuredProjects, projectCarouselIndices, carouselIntervals)
